...
pokemons.forEach((pokemon) => {
	...
	elInner.appendChild(elCard);
	elCard.appendChild(elImg);
	elCard.appendChild(elCardBody);
	elCardBody.appendChild(elTittle);
	elCardBody.appendChild(elText);
	elCardBody.appendChild(elWeaknesses);
	elCardBody.appendChild(elType);





	elCard.setAttribute("class", "card w-25 d-flex");
	...
	elImg.setAttribute("style", "width: 100px; height:100px;");
	elType.setAttribute("style", "color:blue;")
	elWeaknesses.setAttribute("style", "color:red;")
	...
	elTittle.textContent = pokemon.name;
